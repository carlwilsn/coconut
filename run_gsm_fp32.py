...
RUNS = [
    {
        "name": "gsm_cot_fp32",
        "cfg": "args_a10/gsm_cot_a10_fp32.yaml",          # bf16 baseline; also the Coconut init
        "mode": "cot",
        "eval_resume": 0,
        "max_hours": 20.0,
    },
    {
        "name": "gsm_nocot_fp32",
        "cfg": "args_a10/gsm_nocot_a10_fp32.yaml",         # bf16 baseline
        "mode": "cot",
        "eval_resume": 0,
        "max_hours": 16.0,
    },
    {
        "name": "gsm_coconut_fp32",
...
def main():
    ...
    for run in RUNS:
        ...
        if run["name"] == "gsm_coconut_fp32":
            cot_meta_path = "best_ckpts/gsm_cot_fp32_META.json"
